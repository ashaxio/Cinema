        ...
        <div className='px-36 py-10'>
          ...
          {user ? (
            ...
            <div className='flex justify-center my-5 relative'>
              <div className='absolute text-center lg:min-w-196 min-h-full z-10 bg-black/30 rounded-lg p-5 flex justify-center items-center text-3xl font-bold'>
                Авторизуйтеся, щоб мати змогу оцінити фільм.
              </div>
              <form className=' filter blur-md flex flex-col gap-y-5 min-h-50 w-86 bg-[#1E293B] rounded-lg shadow-lg p-5 hover:scale-105 transition-all m-15'>
                <label
                  htmlFor='rating'
                  className='text-center text-2xl font-bold'
                >
              ...
              <div>
                ...
                <div className='flex flex-wrap gap-3 px-16'>
                  {movie.ratings.map((rating, i) => (
                    <div
                      key={i}
                      className='flex flex-col gap-y-3 min-h-36 min-w-36 bg-[#1E293B] rounded-lg shadow-lg p-5 hover:scale-105 transition-all'
                    >
