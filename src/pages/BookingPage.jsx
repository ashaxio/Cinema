  ...
  useEffect(() => {
    ...
    if (bookingSuccess) {
      ...
      if (sessionId === Number(id)) {
        setBookingMessage(
          `Ваші квитки з місцями: ${seats.join(
            ', '
          )} успішно заброньовані✅. Гарного перегляду!`
        );
  ...
  return (
    <Navbar>
      ...
      <div className='flex flex-col lg:flex-row gap-4 md:gap-8 p-4 md:p-8 text-[var(--text-color)] min-h-screen'>
        {/*Left side - Movie and session info */}
        ...
        <div className='w-full lg:w-2/3'>
          <h2 className='text-xl md:text-2xl font-semibold mb-4'>
            {!user ? 'Доступні місця' : 'Оберіть місця'}
          </h2>
