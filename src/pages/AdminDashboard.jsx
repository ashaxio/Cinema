...
const generateEngagementMetrics = () => [
  {
    ...
    value: (3 + Math.random() * 2).toFixed(1) + "/5",
  },
  {
    name: "Середній час перегляду",
    value: Math.floor(70 + Math.random() * 30) + " хв",
  },
  {
    name: "Частота повернень",
    value: Math.floor(3 + Math.random() * 4) + " x тиждень",
  },
];
    ...
    if (!loading && films && films.length > 0) {
      ...
      const recent = sortedFilms.slice(0, 5).map((film) => ({
        ...
        added: film.addedDate
          ? new Date(film.addedDate).toLocaleDateString()
    ...
    <Navbar>
      <div className="p-6 min-h-screen">
        <div className="space-y-6 max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between bg-[var(--bg-navbar-main)] p-4 rounded-lg shadow">
            <div>
            ...
            <div className="mt-4 md:mt-0 flex flex-col md:flex-row items-start md:items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center px-3 py-1.5 bg-black-600 text-[var(--text-color)] rounded-md hover:bg-blue-700 transition-colors text-bold gap-1"
                >
                  <Icons.Refresh />
                  Оновити
                </button>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <label
                    htmlFor="autoRefresh"
                    className="text-bold text-white-900"
                  >
                    Авто-оновлення
                  </label>
                </div>
                ...
                {autoRefresh && (
                  <select
                    ...
                    className="text-bold border-gray-300 rounded-md text-[var(--text-color)]"
                  >
                    <option
                      value={5000}
                      className={
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 bg-[var(--bg-navbar-main)] rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-white-900">
                  Графік переглядів
                </h2>
                <select
                  className="text-sm border-gray-300 rounded-md text-[var(--text-color)]"
            ...
            <div className="bg-[var(--bg-navbar-main)] rounded-lg shadow p-6">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor:
                              genre.name === "Розважальне"
                                ? "#3b82f6"
                                : genre.name === "Фентезі"
                                ? "#ea580c"
                                : genre.name === "Екшн"
                                ? "#a855f7"
                                : genre.name === "Драматичне"
                                ? "#10b981"
                                : "#ef4444",
                          }}
                        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="bg-[var(--bg-navbar-main)] rounded-lg shadow p-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-white-900">
                  Метрики залучення користувачів
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {engagementMetrics.map((metric, index) => (
                  <div
                    key={index}
                    className="bg-[var(--bg-metric)] p-4 rounded-lg"
                  >
