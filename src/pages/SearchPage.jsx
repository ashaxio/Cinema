...
const SearchPage = () => { 
  ...
  const [activeFilters, setActiveFilters] = useState({ genres: false, rating: false, releaseYear: false, countries: false });
  ...
  useEffect(() => {
    ...
    const filtered = films.filter(movie => {
      const isGenreMatch = selectedGenres.length === 0 || 
        selectedGenres.some(genre => movie.genre && movie.genre.includes(genre));
      ...
      const isCountryMatch = selectedCountries.length === 0 || 
        (movie.countries && movie.countries.some(c => selectedCountries.includes(c)));
                ...
                {allGenres.map(genre => (
                  <div 
                    ...
                    className={`flex items-center justify-between p-2 cursor-pointer rounded ${
                      selectedGenres.includes(genre) ? 'bg-gray-700' : 'hover:bg-gray-700/50'
                    }`}
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="w-full"
                />
                <div className="ml-2">{ratingValue > 0 ? ratingValue : 'Any'}</div>
              </div>
            </div>
              ...
              <div className="relative mb-4">
                ...
                >
                  ...
                  <div className="w-4 h-4 flex items-center justify-center">
                    <svg className={`w-4 h-4 transform ${isYearDropdownOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-lg font-semibold mb-2">COUNTRIES</div>
                <div className="relative mb-4">
                  ...
                  >
                    ...
                    />
                    <div className="w-4 h-4 flex items-center justify-center">
                      <svg className={`w-4 h-4 transform ${isCountriesDropdownOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
                      </svg>
                    </div>
                  </div>
